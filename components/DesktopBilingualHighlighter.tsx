    ...
    <div className={`${inter.className}`}>
      <div 
        className={cn(
          ...
          isExpanded ? "max-w-4xl lg:max-w-6xl" : "max-w-2xl lg:max-w-4xl"
        )}
      >
        ...
        <div className={cn(
          ...
          <div className="flex flex-col gap-2 w-full lg:pr-10">
            <h3 className="text-zinc-500 text-xs font-semibold tracking-widest uppercase mb-2">
              {currentLanguage === "EN" ? "English" : "Français"}
            </h3>
            <p className="text-base md:text-lg lg:text-xl leading-relaxed font-light tracking-wide text-zinc-300">
          ...
          {isExpanded && (
            <div className="flex flex-col gap-2 animate-fade-in border-t pt-8 mt-8 lg:border-t-0 lg:pt-0 lg:mt-0 lg:border-l lg:pl-10 border-zinc-800/50">
              <h3 className="text-zinc-500 text-xs font-semibold tracking-widest uppercase mb-2">
        ...
        <div className="flex justify-center mt-2 lg:mt-6 mb-2">
          <button
        ...
        <div 
          ...
          className={cn(
            "cursor-pointer w-full rounded-xl p-6 lg:p-8 border transition-all duration-500 ease-in-out flex items-center justify-center text-center",
            showSolution 
